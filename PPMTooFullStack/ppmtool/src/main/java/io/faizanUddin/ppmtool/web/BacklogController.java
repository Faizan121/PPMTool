...
import io.faizanUddin.ppmtool.services.ProjectTaskService;
...
public class BacklogController {
                                               ...
                                               @PathVariable String backlog_id, @PathVariable String pt_id, Principal principal )
    {
        ...
        ProjectTask projectTask1 = projectTaskService.updatePTByProjectSequence(updatedProjectTask,backlog_id,pt_id, principal.getName() );
